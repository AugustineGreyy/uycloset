...
//
// -> Error: "column clothing_items.is_featured does not exist" or similar
...
// -- Run this for each table you create: clothing_items, review_images, categories, etc.
...
export const addClothingItem = async (
    ...
    const name = `${category} - ${new Date().toISOString()}`;
    let attempts = 0;
    const maxAttempts = 5;
