...
export const TikTokIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" {...props}>
        <path d="M448 209.9a210.1 210.1 0 01-122.8-39.25V349.4a162.6 162.6 0 11-162.6-162.6V278.2a74.6 74.6 0 1052.2 71.2V0h88a121.2 121.2 0 001.9 22.2h0A122.2 122.2 0 00381 102.4a121.4 121.4 0 0067 20.1z"/>
    </svg>
);

export const WhatsAppIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.894 11.892-1.99 0-3.903-.52-5.586-1.456l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.886-.001 2.267.655 4.398 1.803 6.12l-1.34 4.915 5.068-1.325zM9.356 8.014c-.196-.333-.37-.34-.514-.346-.123 0-.267-.006-.41-.006s-.41.063-.625.333c-.229.28-.791.787-.965 1.488-.174.701-.174 1.29.029 1.833.197.534.891 1.489 1.942 2.522 1.463 1.409 2.673 1.859 3.292 2.14.881.402 1.457.329 1.95.196.534-.143 1.489-.615 1.711-1.212.222-.597.222-1.109.162-1.212-.06-.102-.207-.162-.41-.267-.206-.102-.953-.469-1.103-.52-.15-.05-.267-.08-.384.08-.133.163-.491.615-.607.732-.117.116-.214.132-.41.05-.197-.08-.891-.333-1.691-.983-.629-.514-1.057-1.157-1.184-1.359-.126-.202-.016-.319.068-.41.08-.08.162-.214.24-.319.08-.102.133-.163.197-.28.064-.116.031-.214-.016-.299-.047-.08-.41-1.057-.56-1.44z"/>
    </svg>
);
